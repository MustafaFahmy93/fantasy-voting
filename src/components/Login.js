                    ...
                    <div className="container px-6 py-24 mx-auto lg:py-32">
                            ...
                            <div className="mt-8 lg:w-1/2 lg:mt-0">
                                <form className="w-full lg:max-w-xl">
                                    ...
                                    <div className="relative flex items-center mt-4">
                                        ...
                                        <input id="password" type="password" value="admin" className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Password" />
                                    </div>
                                    <div className="mt-8 md:flex md:items-center">
                                        ...
                                        <p href="/" className="cursor-pointer inline-block mt-4 text-center text-blue-500 md:mt-0 md:mx-6 hover:underline dark:text-blue-400">
                        ...
                        <div className="mt-8 md:mt-24 sm:flex sm:items-center">
                            ...
                            <div className="flex items-center mt-4 sm:mt-0 -mx-1.5 sm:w-1/2">
                                <p className="cursor-pointer mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="/">
